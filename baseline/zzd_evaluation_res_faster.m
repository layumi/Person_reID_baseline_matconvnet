...
%% add necessary paths
query_dir = '/home/zzd/market1501/query_pytorch/query/';% query directory
test_dir = '/home/zzd/market1501/gallery_pytorch/bounding_box_test/';% database directory

%% calculate query features
xx = 0.05;
Hist_query = importdata('../test/resnet_query_pool5n.mat')';
nQuery = size(Hist_query, 2);

%% calculate database features
Hist_test = importdata('../test/resnet_gallery_pool5n.mat')';
